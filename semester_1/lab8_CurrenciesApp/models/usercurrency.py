class Usercurrencies():
    """
    Модель, связывающая пользователей и валюты, на которые они подписаны
    """
    def __init__(self, id: str, user_id: str, currency_id: str):
        """
        :param id: id связи
        :param user_id: id пользователя
        :param currency_id: id валюты, на которую подписан пользователь
        """
        self.id: str = id
    ...
    def id(self, id: str):
        if type(id) is str:
            ...
            raise ValueError('Ошибка при задании id связи')
