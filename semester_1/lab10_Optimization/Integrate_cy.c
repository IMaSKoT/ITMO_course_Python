...
static double __pyx_f_12Integrate_cy_integrate_cy(PyObject *, double, double, long, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_12Integrate_cy_integrate_sin_pure_c(double, double, long, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_12Integrate_cy_integrate_nogil(double, double, int, int __pyx_skip_dispatch); /*proto*/
...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_12Integrate_cy_integrate_cy(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_f, double __pyx_v_a, double __pyx_v_b, long __pyx_v_n_iter); /* proto */
static PyObject *__pyx_pf_12Integrate_cy_2integrate_sin_pure_c(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, long __pyx_v_n_iter); /* proto */
static PyObject *__pyx_pf_12Integrate_cy_4integrate_nogil(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter); /* proto */
...
#define __pyx_n_u_Integrate_cy __pyx_string_tab[2]
...
#define __pyx_n_u_integrate_nogil __pyx_string_tab[11]
#define __pyx_n_u_integrate_sin_pure_c __pyx_string_tab[12]
...
#define __pyx_kp_b_iso88591_A_a_Cr_E_aq_3ar_2RvRq_1 __pyx_string_tab[25]
#define __pyx_kp_b_iso88591_a_Cr_U_1_Bb_A_q_Ba_1 __pyx_string_tab[26]
#define __pyx_kp_b_iso88591_a_Cr_U_1_s_2Rr_6_1_1 __pyx_string_tab[27]
...
static PyObject *__pyx_pw_12Integrate_cy_1integrate_cy(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static double __pyx_f_12Integrate_cy_integrate_cy(PyObject *__pyx_v_f, double __pyx_v_a, double __pyx_v_b, long __pyx_v_n_iter, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_acc;
  double __pyx_v_step;
  long __pyx_v_i;
  double __pyx_v_x;
 ...
 * 
*/
    __pyx_t_5 = PyFloat_FromDouble(__pyx_v_acc); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_7 = NULL;
    __Pyx_INCREF(__pyx_v_f);
    __pyx_t_8 = __pyx_v_f; 
    __pyx_t_9 = PyFloat_FromDouble(__pyx_v_x); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 13, __pyx_L1_error)
    ...
    __pyx_t_8 = PyFloat_FromDouble(__pyx_v_step); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_9 = PyNumber_Multiply(__pyx_t_6, __pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = PyNumber_InPlaceAdd(__pyx_t_5, __pyx_t_9); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
...
*/
  ...
  __Pyx_AddTraceback("Integrate_cy.integrate_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyMethodDef __pyx_mdef_12Integrate_cy_1integrate_cy = {"integrate_cy", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_12Integrate_cy_1integrate_cy, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_12Integrate_cy_1integrate_cy(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_cy", 0) < (0)) __PYX_ERR(0, 4, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 4; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_cy", 1, 4, 4, i); __PYX_ERR(0, 4, __pyx_L3_error) }
      }
    ...
    __pyx_v_f = values[0];
    __pyx_v_a = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_n_iter = __Pyx_PyLong_As_long(values[3]); if (unlikely((__pyx_v_n_iter == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("integrate_cy", 1, 4, 4, __pyx_nargs); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __pyx_r = __pyx_pf_12Integrate_cy_integrate_cy(__pyx_self, __pyx_v_f, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_12Integrate_cy_integrate_cy(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_f, double __pyx_v_a, double __pyx_v_b, long __pyx_v_n_iter) {
  ...
  __pyx_t_1 = __pyx_f_12Integrate_cy_integrate_cy(__pyx_v_f, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter, 1); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L1_error)
...
static PyObject *__pyx_pw_12Integrate_cy_3integrate_sin_pure_c(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static double __pyx_f_12Integrate_cy_integrate_sin_pure_c(double __pyx_v_a, double __pyx_v_b, long __pyx_v_n_iter, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_acc;
  double __pyx_v_step;
  int __pyx_v_i;
  double __pyx_r;
 ...
 * 
*/
    __pyx_v_acc = (__pyx_v_acc + (sin((__pyx_v_a + (__pyx_v_i * __pyx_v_step))) * __pyx_v_step));
  }
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("Integrate_cy.integrate_sin_pure_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
static PyMethodDef __pyx_mdef_12Integrate_cy_3integrate_sin_pure_c = {"integrate_sin_pure_c", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_12Integrate_cy_3integrate_sin_pure_c, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_12Integrate_cy_3integrate_sin_pure_c(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("integrate_sin_pure_c (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_sin_pure_c", 0) < (0)) __PYX_ERR(0, 16, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_sin_pure_c", 1, 3, 3, i); __PYX_ERR(0, 16, __pyx_L3_error) }
      }
    ...
    __pyx_v_b = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_n_iter = __Pyx_PyLong_As_long(values[2]); if (unlikely((__pyx_v_n_iter == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("integrate_sin_pure_c", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 16, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_12Integrate_cy_2integrate_sin_pure_c(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_12Integrate_cy_2integrate_sin_pure_c(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, long __pyx_v_n_iter) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("integrate_sin_pure_c", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_12Integrate_cy_integrate_sin_pure_c(__pyx_v_a, __pyx_v_b, __pyx_v_n_iter, 1); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L1_error)
  __pyx_t_2 = PyFloat_FromDouble(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_12Integrate_cy_5integrate_nogil(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static double __pyx_f_12Integrate_cy_integrate_nogil(double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_acc;
  double __pyx_v_step;
  int __pyx_v_i;
  double __pyx_r;
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("Integrate_cy.integrate_nogil", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
static PyMethodDef __pyx_mdef_12Integrate_cy_5integrate_nogil = {"integrate_nogil", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_12Integrate_cy_5integrate_nogil, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_12Integrate_cy_5integrate_nogil(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("integrate_nogil (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_nogil", 0) < (0)) __PYX_ERR(0, 24, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_nogil", 1, 3, 3, i); __PYX_ERR(0, 24, __pyx_L3_error) }
      }
    } else if (unlikely(__pyx_nargs != 3)) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_n_iter = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("integrate_nogil", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 24, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_12Integrate_cy_4integrate_nogil(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_12Integrate_cy_4integrate_nogil(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("integrate_nogil", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_12Integrate_cy_integrate_nogil(__pyx_v_a, __pyx_v_b, __pyx_v_n_iter, 1); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L1_error)
 ...
 *     cdef double acc = 0.0
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_12Integrate_cy_1integrate_cy, 0, __pyx_mstate_global->__pyx_n_u_integrate_cy, NULL, __pyx_mstate_global->__pyx_n_u_Integrate_cy, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_integrate_cy, __pyx_t_2) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
 ...
 *     cdef double step = (b - a) / n_iter
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_12Integrate_cy_3integrate_sin_pure_c, 0, __pyx_mstate_global->__pyx_n_u_integrate_sin_pure_c, NULL, __pyx_mstate_global->__pyx_n_u_Integrate_cy, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_integrate_sin_pure_c, __pyx_t_2) < (0)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     cdef double step = (b - a) / n_iter
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_12Integrate_cy_5integrate_nogil, 0, __pyx_mstate_global->__pyx_n_u_integrate_nogil, NULL, __pyx_mstate_global->__pyx_n_u_Integrate_cy, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[2])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_integrate_nogil, __pyx_t_2) < (0)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{16},{12},{20},{1},{18},{1},{18},{1},{8},{12},{15},{20},{13},{5},{8},{10},{6},{8},{3},{12},{12},{10},{8},{6},{63},{67},{60}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (355 bytes) */
const char* const cstring = "BZh91AY&SY#\n\300\236\000\000(\177\363\366|\273d0\0019\000\276!R\000\277\257\377`\000@@@@\000@@@\000@\0000\001\tP4SA\242\237\246 Q\241\246\324\003 \036\246\2003\032\247\345B\032F\215E6\246OH\304\321\221\210\014\231\031\031\244\365\032l\247\241\314\000\023&\000\023\t\202a\014\001\030\002G\027h\310fOy\231\031\224\337\302\010\001RR\264\024j\002\002\203\006\016\265\tA(!\200\247M\234\346\312j\006@\217\010j\357\033':\343\031\"JK\0046\005\302\215\364V\352\305BR\017\006\300A\220\325\350\340H\0203SW\375\221>\0202\215\3229f\350\215\246CR0tD\315\ry\206FT\030\257' \204f\014\355h\311\366\005\256\"\030\276\324\313W\000L.\270\351\002L.\310\340\360}\360W\202\212\024\031\346\352\211\010\272\247\355\264W\212v+\343\257\016\246\331q\n\247\022\213\311\215M\252\021]LW\325\303\305\030\224\205\304(\023\260\034\023\246k\364X&\257\220R\307\230jQ\263^\005\260w\207m\026\353\301\360\013\366\304\276\362<\3679x\226\241\267\"\317\001If\034\262\246\005;ROO\344\233\2550\307\302\"D\021\026\231\014\313\374]\311\024\341B@\214+\002x";
    ...
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib