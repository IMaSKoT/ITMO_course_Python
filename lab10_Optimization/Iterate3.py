...
def integrate_async(f, a: float, b: float, *, n_jobs=2, n_iter: int = 100000000):
    """
    Функция вычисления интеграла асинхронно с использованием процессов
...
if __name__ == '__main__':
    ...
    for n in range(2, 20, 2):
        print(f'Время для {n} процессов:',
              timeit.timeit(lambda: integrate_async(math.sin, 0, math.pi, n_jobs=n), number=1))
